...
class Spider(object):
    ...
    def loadPage(self, code):
        ...
        #    stock = (name + price + info[22:24] + info[30:32] + info[40:42] + info[32:34] + info[42:44] + gr + stocks)
            stock = ( name + price + info[23:24] + info[31:32] + info[41:42] + info[33:34] + info[43:44] + growrate + stocks)
        else:
            stock = ( name + price + info[23:24] + info[31:32] + info[41:42] + info[33:34] + info[43:44] + growrate + stocks)
        
        self.writePage(stock)
    ...
    def writePage(self, stock):
        ...
        # 写入表格
        for col, sk in zip(range(1,10), stock):
